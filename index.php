...
class TabContent {
	...
	function onInit() {
		...
		wp_set_script_translations('tcb-tabs-editor-script', 'tab-content', plugin_dir_path(__FILE__) . 'languages'); // Translate
	}
	...
	function render($attributes, $content) {
		...
		ob_start(); ?>
		<div class='<?php echo esc_attr($blockClassName); ?>' id='tcbTabContent-<?php echo esc_attr($cId); ?>' data-attributes='<?php echo esc_attr(wp_json_encode($attributes)); ?>'>
			<style>
				...
				<ul class='tabMenu'>
					...
					?>
						<li id='menuItem-<?php echo esc_attr($cId); ?>'>
							<style>
								<?php echo esc_html( "#tcbTabContent-$cId .tabMenu #menuItem-$cId .menuIcon i{
									$iconStyles
								}" ); ?>
							</style>
